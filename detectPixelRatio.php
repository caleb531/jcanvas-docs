<h2>Detect Pixel Ratio</h2>

<p>As of v13.06.08, jCanvas offers a <code>detectPixelRatio()</code> method for detecting high-resolution displays (including devices with retina displays).</p>
