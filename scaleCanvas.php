...
<pre class="prettyprint lang-js demo">
// The scale property scales both the x- and y- axis
$("canvas").scaleCanvas({
  x: 100, y: 100,
  scale: 3,
})
...
<p>Rather than scaling the entire canvas, you can scale an individual shape using any of these three properties.</p>
